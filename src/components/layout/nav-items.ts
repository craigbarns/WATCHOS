import { FileText, LayoutDashboard, MonitorSmartphone, ChartColumn, Settings, Users, Wrench } from 'lucide-react'
...
export const NAVIGATION: NavItem[] = [
  ...
  { name: 'Statistiques', short: 'Stats', href: '/statistiques', icon: ChartColumn, roles: ['ADMIN', 'VENDEUR'] },
